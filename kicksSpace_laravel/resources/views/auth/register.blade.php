    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading reg-title">Реєстрація</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email-reg" class="col-md-4 control-label">E-Mail</label>
                        ...
                        <div class="form-check form-check-inline radio-item">
                            ...
                            <label class="form-check-label" for="male">Чол.</label>
                        </div>

                        <div class="form-check form-check-inline radio-item">
                            <input class="form-check-input" type="radio" name="gender" id="female" value="female">
                            <label class="form-check-label" for="female">Жін.</label>
                        </div>

                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password-reg" class="col-md-4 control-label">Пароль</label>

                            <div class="col-md-6">
                                <input id="password-reg" type="password" class="form-control" name="password" required>
